...
export default function Home() {
    ...
    const handlePostPopEmojiTwoOutside = (event) => {
    ...
    const handlePostPopEmojiThreeOutside = (event) => {
    ...
    const handlePostPopEmojiFourOutside = (event) => {
    ...
    const handlePostPopEmojiFiveOutside = (event) => {
