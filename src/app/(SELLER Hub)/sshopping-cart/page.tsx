            ...
            <section id="shopping-cart-section">
                <div className="w-full pt-[50px] pb-20">
                    <div className="ml-0 lg:ml-[295px]">
                        <div className="mx-5">
                            <div className="cart_content mt-4">
                                    ...
                                    <div className="one">
                                            ...
                                            {loading ? (
                                                ...
                                                <>
                                                    <h4 className="text-[14px] text-prgcolor font-[500]">
                                                        Store name <span
                                                        className="text-graycolor font-normal">2 items</span>
                                                    </h4>
                                                </>
                                            )}
                                        </div>
                                        ...
                                        <div className="product_wrap px-6 flex items-center justify-between">
                                            {loading ? (
                                                ...
                                                <>
                                                    <Link href='#'
                                                          className="show_product group mt-2 flex items-center gap-4">
                                                        ...
                                                        <div className="product_content">
                                                            ...
                                                            <div
                                                                className="block lg:hidden show_price text-[14px] text-black">
                                                                <h4>$860.00</h4>
                                                            </div>
                                                        </div>
                                                    </Link>
