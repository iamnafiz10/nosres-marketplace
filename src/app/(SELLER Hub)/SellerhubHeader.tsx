    ...
    return (
        <>
            <section id="header-section" className="relative">
                ...
                >
                    <div className="w-full px-5 block lg:flex items-center justify-between">
                        <div className="logo_search_wrap flex items-center gap-36">
                            {/* Logo */}
                            <div className="ml-[0px] hidden lg:flex logo">
                                <Link href='/' className="flex items-center gap-2">
                                    <Image src={LogoImg} className="h-10 w-7" alt="LogoImg"/>
                                    <span className="font-[500] text-[16px]">Seller Hub</span>
                                </Link>
                            </div>

                            {/* Search */}
                            <div
                                className={`ml-0 lg:ml-10 hidden lg:flex search-bar relative ${isSearchExpanded ? 'w-60 lg:w-96' : 'w-72'}`}>
                                <input
                                    ref={inputRef}
                                    type="text"
                        ...
                        {/* Menu */}
                        <div
                            className="nav hidden lg:flex items-center justify-end text-[12px] gap-8">
                            {/* Home */}
                            ...
                            {/* Business Icon */}
                            <Tooltip content="For Business" placement="bottom" style="light" className="tooltip_design">
                            ...
                            {/* User Icon */}
                            <Tooltip content="Profile" placement="bottom" style="light" className="tooltip_design">
                        ...
                        {/* Mobile/Tab Icons */}
                        <div className="block lg:hidden mobile_tab_menu w-full">
