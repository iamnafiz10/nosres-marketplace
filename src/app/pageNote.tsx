                                ...
                                <div className="post_write_comment mt-0">
                                    <div
                                        ...
                                        <div className="relative w-full flex items-center">
                                            <HiUserCircle size={40} className="text-[#6B7280]"/>
                                            <input
                                                className="m-0 rounded-full w-full py-1 px-3 border-graycolor focus:border-primary focus:ring focus:ring-transparent text-[#ABABAB] text-[14px] focus:outline-none"
                                                type="text"
                                            ...
                                            <div className="absolute inset-y-0 right-2 flex items-center gap-4">
                                                ...
                                                <div onClick={() => setPickerVisible(!isPickerVisible)}
