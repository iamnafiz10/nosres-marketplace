...
// Input dynamic
    ...
    const handleToggleDropdownBone = () => {
        setOpenBone(prev => !prev);
    };
    const menuRefBone = useRef<HTMLDivElement>(null);
    // Close dropdown if clicked outside
    useEffect(() => {
        const handleClickOutside = (e: MouseEvent) => {
            if (menuRefBone.current && !menuRefBone.current.contains(e.target as Node)) {
                setOpenBone(false);
            }
        };
        document.addEventListener("mousedown", handleClickOutside);
    ...
    //---------- Unsend and Delete Modal --------------------//
    const [openUnsendModal, setopenUnsendModal] = useState<boolean>(false);
    ...
    return (
        <>
                            ...
                            <div className="col lg:col-span-12 message_box_wrap rounded bg-white py-4">
                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-12 border-t pb-4 h-full">
                                    <div className="col lg:col-span-4 hidden lg:block border-r">
                                        <div
                                            className="user_box space-y-0 w-full h-[76vh] overflow-y-auto">
                                            <div
                                    ...
                                    <div className="col lg:col-span-8">
                                        <div
                                            className={`box w-full h-full relative ${showEdit ? "pointer-events-none" : ""}`}>
                                            ...
                                            >
                                                            ...
                                                            {open && (
                                                                <div
                                                                    ...
                                                                    <ul className="flex flex-col text-sm text-gray-700">
                                                                        ...
                                                                        <li onClick={() => setopenUnsendModal(true)}
                                                                            className="flex items-center gap-2 px-4 py-2 hover:bg-gray-100 cursor-pointer">
                                                        ...
                                                        <div
                                                            ...
                                                            <div className="bg-white w-full pl-2 pr-8 py-2 rounded-xl">
                                                                <div className="border-l-2 border-blue-500">
                                                                    ...
                                                                    <h4 className="ml-1 text-[14px] text-prgcolor text-left">
                                                                        As a matter of security, we are unable to<br/>
                                                                        assist with Account Security Issues. Please<br/>
                                                                        reach out to the link we provided...
                                                                    </h4>
                                                                </div>
                                                            </div>

                                                            <h4 className="mt-2 pl-1 text-[14px] text-prgcolor text-left">
                                                                As a matter of security, we are unable to<br/>
                                                                assist with Account Security Issues. Please<br/>
                                                                reach out to the link we provided.
                                                            </h4>
                                                ...
                                                <div className="message pt-[25px] flex ml-auto justify-end">
                                                    <div className="wrap">
                                                        <div className="relative w-fit group">
                                                            {/* Message Bubble */}
                                                            <div
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div className="border-l-2 border-green-500">
                                                                        <h4 className="ml-1 text-green-500 text-[14px]">
                                                                            You
                                                                        </h4>
                                                                        <h4 className="ml-1 text-[14px] text-prgcolor text-left">
                                                                            As a matter of security, we are unable
                                                                            to<br/>
                                                                ...
                                                                <h4 className="mt-2 pl-1 text-[14px] text-white text-left">
                                                                    As a matter of security, we are unable to<br/>
                                                                    assist with Account Security Issues. Please<br/>
                                                                    reach out to the link we provided.
                                                                </h4>
                                                                    ...
                                                                    <div className="border-l-2 border-green-500">
                                                                        <div
                                                                            ...
                                                                            <div className="left ml-1">
                                                                                <h4 className="text-green-500 text-[14px]">
                                                                                    Jane Doe
                                                                                </h4>
                                                                                <div
                                                                                    className="flex items-center gap-1">
                                                                                    <div
                                                                                        className="icon text-graycolor">
                                                                                        <LuImage size={16}/>
                                                                                    </div>
                                                                                    <h4 className="text-[12px] text-graycolor">
                                                                                        Photo
                                                    ...
                                                    <div className="wrap">
                                                        <div className="relative w-fit group">
                                                            <div
                                                                className="bg-[#3197f5] inline-block py-2 pl-4 pr-10 rounded-2xl rounded-br-none">
                                                                <h4 className="text-[14px] text-white">
                                                                    Design for edited message
                                                                </h4>
                                                            </div>
                                                        </div>
                                                        <h6 className="text-[12px] mt-1 text-prgcolor leading-none text-end">
                                                            Edited
                                                        </h6>
                                                        <h6 className="text-[10px] mt-2 text-graycolor leading-none text-end">
                                                            Oct 20, 2017, 1:23 AM
                                                        </h6>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="message flex flex-col items-center justify-center mt-4">
                                                    <div
                                                        ...
                                                        <div ref={menuRefBone}
                                                             className="protected_message bg-[#F6FAFF] rounded-full p-2 border relative group">
                                                            <h4 className="text-[12px] text-graycolor">
                                                            ...
                                                            >
                                                                {/* Three Dots Icon */}
                                                                <span onClick={handleToggleDropdownBone}
                                                                      className="cursor-pointer">
                                                                <BiDotsHorizontalRounded
                                                                    size={20}
                                                                    className={openBone ? "text-primary" : "text-graycolor"}
                                                                />
                                                              </span>
                                                                ...
                                                                {openBone && (
                                                                    <div
                                                                        className="absolute top-[30px] right-0 w-40 bg-white shadow-lg rounded-md py-2 z-50">
                                                                        <ul className="flex flex-col text-sm text-gray-700">
                                                                            <li className="flex items-center gap-2 px-4 py-2 hover:bg-gray-100 cursor-pointer">
                                                                                <LuCircleX className="text-graycolor"
                                                                                           size={16}/> Remove
                                                                            </li>
                                                                        </ul>
                                                                    </div>
                                            ...
                                            {showEdit && (
                                                <>
                                                    ...
                                                    <div
                                                        className="edit_message absolute bottom-[153px] z-30 w-full pointer-events-auto">
                                                        <div
                                                            className="w-full relative bg-white rounded rounded-b-none py-2 px-8 border-t">
                                                            {/* Close button */}
                                                            <button onClick={() => setShowEdit(false)} type='button'
                                                                    className="absolute top-2 right-2 text-graycolor hover:text-primary"
                                                            >
                                                                <RxCross2 size={17}/>
                                                            </button>

                                                            <h4 className="text-[16px] text-primary">
                                                                Edit Message
                                                            </h4>
                                                            <h4 className="text-[14px] text-black mt-2">
                                                                As a matter of security, we are unable to assist with
                                                                Account
                                                                Security
                                                                Issues. Please reach<br/> out to the link we provided.
                                                            </h4>
                                                        </div>
                                                    </div>
                                                </>
                                            ...
                                            {showReply && (
                                                <>
                                                    <div
                                                        className="reply_message absolute bottom-[219px] z-30 w-full pointer-events-auto">
                                                        <div
                                                            className="w-full relative bg-white rounded rounded-b-none py-2 px-8 border-t">
                                                            {/* Close button */}
                                                            <button onClick={() => setShowReply(false)} type='button'
                                                                    className="absolute top-2 right-2 text-graycolor hover:text-primary"
                                                            >
                                                                <RxCross2 size={17}/>
                                                            </button>
                                                            ...
                                                            <div className="flex items-center justify-between">
                                                                <div className="left">
                                                                    <h4 className="text-[16px] text-primary">
                                                                        Replying to John Doe (or yourself)
                                                                    </h4>
                                                    ...
                                                    <div
                                                        className="reply_message absolute bottom-[153px] z-30 w-full pointer-events-auto">
                                                        <div
                                                            className="w-full relative bg-white rounded rounded-b-none py-2 px-8 border-t">
                                                            {/* Close button */}
                                                            <button onClick={() => setShowReply(false)} type='button'
                                            ...
                                            {isBlocked ? (
                                                <div className="w-full absolute z-30 bg-white bottom-5">
                                                ...
                                                <div ref={modalRef}
                                                     className="w-full absolute z-30 bg-white bottom-5 pointer-events-auto">
                                                    ...
                                                    <div className="icon_box px-4 pb-4 w-full border-t">
                                                        <div className="flex items-center justify-between mt-3">
                                                            <div className="relative flex items-center gap-2">
                                                                ...
                                                                {showStartPostEmoji &&
                                                                    <div ref={emojiPickerRef}
                                                                         className="comment_emoji z-40 absolute bottom-[30px] left-0 lg:left-auto right-auto lg:right-0">
                                                                        <Picker
                                                                            data={data}
                                                                            theme="light"
                                                                            perLine={8}
                                                            ...
                                                            {!showEdit ? (
                                                                ...
                                                                <li className="flex items-center gap-2 p-1 bg-primary rounded-full text-white cursor-pointer">
                                                                    <LuCheck size={16}/>
                                                                </li>
                                                            )}
                                                        </div>
            ...
            <Modal size="lg"
                ...
                >
                    <h4 className="text-[16px]">Unsend Message</h4>
                </Modal.Header>
                <Modal.Body>
                    <div className="modal_body">
                        <h4 className="text-graycolor text-[14px]">
                            This message will only be deleted from your device. It will not be deleted from
                ...
                <Modal.Footer>
                    <div className="flex w-full items-center justify-between">
                        <button onClick={() => setopenUnsendModal(false)}
            ...
            <Modal size="lg"
                ...
                >
                    <h4 className="text-[16px]">Delete Message</h4>
                </Modal.Header>
                <Modal.Body>
                    <div className="modal_body">
                        <h4 className="text-graycolor text-[14px]">
