...
import {LuBell, LuDot, LuSlidersHorizontal} from "react-icons/lu";
                            ...
                            {isFilterOpen && (
                                <div
                                    ...
                                    <ul className="text-[14px] space-y-2">
                                        <li>
                                            <Link href='#' className="text-graycolor hover:text-prgcolor">All
                                                Notifications</Link>
                                        </li>
                                        <li>
                                            <Link href='#'
                            ...
                            <div className="col lg:col-span-8">
                                <div className="grid grid-cols-1 md:grid-cols-12">
                                            ...
                                            {loading ? (
                                                ...
                                                <>
                                                    ...
                                                    <ul className="mt-4 text-[14px] space-y-2">
                                                        <li>
                                                            <Link href='#'
                                                                  className="text-graycolor hover:text-prgcolor">All
                                                                Notifications</Link>
                                                        </li>
                                                        <li>
                                                            <Link href='#'
                                    ...
                                    <div
                                        ...
                                        <div
                                            className="thank_you_box bg-white rounded-lg text-center py-[35px] px-[55px]">
                                            <div className="flex flex-col items-center justify-center text-center">
                                                <div className="icon bg-gray-100 rounded-full p-4">
                                                    <LuBell className="w-[50px] h-[50px] text-primary"/>
                                                </div>
                                                <h4 className="text-prgcolor text-[18px] mt-3">
                                                    No New Notifications
                                                </h4>
                                                <h4 className="text-graycolor text-[14px] mt-3">
                                                    Notifications from the past 30 days will be<br/> displayed here.
                                                </h4>
                                            </div>
                                        </div>
                                    </div>
