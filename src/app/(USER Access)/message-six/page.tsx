    ...
    return (
        <>
            ...
            <Modal size="lg"
                ...
                >
                    <h4 className="text-[16px]">Unlock Your Messages</h4>
                </Modal.Header>
                <Modal.Body>
                    <div className="modal_body">
                        <h4 className="text-graycolor text-[14px]">
                            For your security, your messages are end-to-end encrypted. To
                            access them on this new device or browser, please enter your
                            passphrase.
                        </h4>
                    ...
                    <div className="modal_body">
                        <div className="flex flex-col items-center justify-center text-center">
                            ...
                            <h4 className="text-graycolor text-[14px] mt-3">
                                Your encrypted messages have been successfully unlocked. You
                                can continue your conversation securely.
                            </h4>
                        </div>
                    </div>
