    ...
    return (
        <>
            <section id="message-section">
                ...
                {/*                /!* Border Make *!/*/}
                {/*                <div className="w-full border-b m-0 p-0"></div>*/}

                {/*                <div className="grid grid-cols-1 lg:grid-cols-12 pb-4 h-full">*/}
                {/*                    <div className="col lg:col-span-5 hidden lg:block">*/}
                {/*                        <div className="user_box space-y-3 w-full border-r h-full">*/}
                ...
                {/*                            <div className="user px-4 mt-2 pb-1 flex items-center gap-2">*/}
                {/*                                <HiUserCircle size={35} className="text-[#6B7280]"/>*/}
                {/*                                <h4 className="text-[14px] font-semibold text-prgcolor hover:underline cursor-pointer">*/}
                {/*                                    Jeff Bently*/}
                {/*                                </h4>*/}
