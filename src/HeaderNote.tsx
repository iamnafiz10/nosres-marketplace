            ...
            <section id="header-section" className="relative">
                ...
                >
                    <div className="container block lg:grid grid-cols-12 items-center">
                        ...
                        {/* Menu */}
                        <div className="col-span-6 nav hidden lg:flex items-center justify-end text-[12px] gap-8">
                            {/* Home */}
                            <Tooltip content="Home" placement="bottom" style="light" className="tooltip_design">
                                <Link href='/' className="group flex flex-col items-center relative">
                                    ...
                                    {pathname === '/home' ? (
                                        <GoHomeFill className="w-[25px] h-[24px] text-primary"/>
                                    ) : (
                                        <GoHome className="w-[25px] h-[24px] text-prgcolor"/>
                                    )}
                                </Link>
                            </Tooltip>
                            ...
                            <Tooltip content="Cart" placement="bottom" style="light" className="tooltip_design">
                                <Link href='#'
                                    ...
                                    {pathname === '/shopping-cart' ? (
                                        <IoCart className="w-[26px] h-[24px] text-primary"/>
                                    ) : (
